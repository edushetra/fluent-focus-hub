...
import { Clock, Users, Calendar, IndianRupee, CheckCircle } from "lucide-react";
...
const programs = [
  ...
  },
  {
    ...
    timings: "9 AM–10 PM",
    flexibility: "Fixed slot (cannot change)",
    price: "₹1,000/month",
  ...
  },
  {
    ...
    modules: ["Executive presence", "Strategic messaging", "Stakeholder communication"],
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 xl:grid-cols-4 gap-8">
          {programs.map((program, index) => (
            <Card key={index} className={`program-card relative ${program.popular ? 'ring-2 ring-secondary' : ''}`}>
              {program.popular && (
                ...
                <div className="space-y-1">
                  ...
                  {program.upfrontPrice && (
                    <p className="text-sm text-muted-foreground">
                      or {program.upfrontPrice} upfront
                    </p>
                  )}
                </div>
              </CardHeader>
              ...
              <CardContent className="space-y-6">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center text-sm text-muted-foreground">
                    ...
                    <span>{program.sessionLength} sessions</span>
                  </div>
                  {program.groupSize && (
                    <div className="flex items-center text-sm text-muted-foreground">
