      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-1">
            <div className="flex items-center space-x-2 mb-6">
              <img src={LOGO} alt="EduShetra Logo" className="h-10 w-auto object-contain" loading="lazy" />
            ...
            <div className="flex space-x-4">
              <a
                href="https://www.facebook.com/people/EduShetra/61580499214015/"
                target="_blank"
              ...
              <a
                href="https://www.instagram.com/edushetra/"
                target="_blank"
                rel="noopener noreferrer"
                className="text-white/60 hover:text-white transition-colors"
              ...
              <a
                href="https://www.youtube.com/@EduShetraOfficial"
                target="_blank"
                rel="noopener noreferrer"
                className="text-white/60 hover:text-white transition-colors"
                aria-label="YouTube"
              ...
              <a
                href="https://www.linkedin.com/company/edushetra/"
                target="_blank"
                rel="noopener noreferrer"
                className="text-white/60 hover:text-white transition-colors"
                aria-label="LinkedIn"
        ...
        <div className="border-t border-white/20 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            ...
            <p className="text-white/60 text-sm">© 2025 EduShetra. All rights reserved.</p>
          </div>
        </div>
      </div>
    </footer>
